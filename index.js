...
function help(t) {
	const helpmsg = [
		"東京都の地震は、のように道州地方、都道府県、市の名前で質問することで地震情報を調べられます。道州地方、都道府県、市の名前で質問ください。",
		"東京都、のように都道府県名だけでも地震情報を調べられます。道州地方、都道府県、市の名前で質問ください。",
		"データはP2P地震情報を一分おきに取得しています。道州地方、都道府県、市の名前で質問ください。",
		"対応している地域は日本国内のみです。道州地方、都道府県、市の名前で質問して地震情報を調べてみてください。",
		//"終了方法は、終了と呼びかけてください。",
	];
	...
	'jishin': function() {
		...
		documentClient.get(params, function(err, data) {
			if (err) {
				...
				result = data.Item.info.s + "道州地方、都道府県、市の名前で質問ください。" ;
